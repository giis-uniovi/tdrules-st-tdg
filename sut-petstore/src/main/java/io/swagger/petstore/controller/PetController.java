...
public class PetController {
    ...
    public ResponseContext addCategory(final RequestContext request, final Category category) {
        if (category == null) {
    ...
    public ResponseContext addPet0(final RequestContext request, final Pet0 pet) {
        if (pet == null) {
            return new ResponseContext()
                    .status(Response.Status.BAD_REQUEST)
                    .entity("No Pet provided. Try again?");
    ...
    public ResponseContext addPet1(final RequestContext request, final Pet1 pet) {
        if (pet == null) {
            return new ResponseContext()
                    .status(Response.Status.BAD_REQUEST)
                    .entity("No Pet provided. Try again?");
    ...
    //Added to test id generation in the backend
    
    public ResponseContext addPetBackId(final RequestContext request, final Pet pet) {
        if (pet == null) {
            return new ResponseContext()
                    .status(Response.Status.BAD_REQUEST)
                    .entity("No Pet provided. Try again?");
    ...
    public ResponseContext addCategoryBackId(final RequestContext request, final Category category) {
        if (category == null) {
            return new ResponseContext()
                    .status(Response.Status.BAD_REQUEST)
                    .entity("No Pet provided. Try again?");
        ...
        petData.addCategoryBackId(category);
