...
public class HospitalService {
	...
	/*Se añade método para guardar los datos del hospital
	  En el original no estaba, de forma que cuando se añaden productos a un hospital, 
	  no se almacenaba la relación
	 */
	...
	/*Parece que cuando se inserta un nuevo hospital lo busca y si no lo encuentra emite excepción. 
	  Debe de buscarlo en Location o algo así y no deja insertar a través de POST.
	  Elimino la comprobación para que permita ejecutar
	  ToDo - Confirmar esto.
	*/
